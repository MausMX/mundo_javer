<div class="container font-poppins">
    <div class="px-3">
	    <div class="row justify-content-center">
	        <div class="col-lg-10 col-md-10 px-3 mb-5">
	            <div class="row bg-white rounded py-3 align-items-center" style="position: relative;">
	                ...
	                <div class="col-8 offset-2 offset-md-0 offset-lg-0 offset-xl-0 col-xl-4 col-lg-4 col-md-3 p-0">
	                    ...
	                    <img class="d-block d-lg-none d-xl-none d-md-none mobile-logo-gracias" src="<?=Path?>/images/registro/gracias_mobile.png">
	                </div>
	                <div class="col-md-9 col-xl-8 col-lg-8" style="position: relative;">
	                    <div class="pr-5 py-4 contenido-gracias">
	                        <div class="">
	                            ...
	                            <p class="font-poppins font-18 mb-4">
	                                <strong class="d-block mb-3">¡Gracias por tu registro y ser parte de Mundo Javer!</strong>
	                                En breve serás contactado por uno de nuestros asesores.
								</p>
	                            <a class="btn btn-success py-2 px-4 font-10 mt-2 btn-continuar text-uppercase" href="<?=Path?>"><strong>Volver a mundo javer</strong></a>
