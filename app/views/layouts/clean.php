...
<html lang="es-MX">
	<head>
		...
		<link rel="stylesheet" href="<?=Path?>/app/views/css/style.css?202111011148" type="text/css">
		<link rel="stylesheet" href="<?=Path?>/app/views/css/style2.css?202111011148" type="text/css">
		<link rel="stylesheet" href="<?=Path?>/app/views/css/style_contador.css?202111011148" type="text/css">
	...
	<body id="<?=$controllerName; ?>" class="<?=$function;?> contador">
		...
		<script type="text/javascript" src="<?=Path?>/app/libs/js/script.js?202111011148"></script>
		<script type="text/javascript" src="<?=Path?>/app/libs/js/script2.js?202111011148"></script>
		<?
