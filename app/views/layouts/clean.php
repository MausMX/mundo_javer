...
<html lang="es-MX">
	<head>
		...
		<link rel="stylesheet" href="<?=Path?>/app/views/css/style.css?202110141744" type="text/css">
		<link rel="stylesheet" href="<?=Path?>/app/views/css/style2.css?202110141744" type="text/css">
		<link rel="stylesheet" href="<?=Path?>/app/views/css/style_contador.css?202110141744" type="text/css">
	...
	<body id="<?=$controllerName; ?>" class="<?=$function;?> contador">
		...
		<script type="text/javascript" src="<?=Path?>/app/libs/js/script.js?202110141744"></script>
		<?
