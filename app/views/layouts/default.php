...
<html lang="es-MX">
	...
	<body id="<?=$controllerName; ?>" class="<?=$function;?> <?=Movil?>">
		...
		<script type="text/javascript" src="<?=Path?>/app/libs/js/script.js?202110261851"></script>
		<script type="text/javascript" src="<?=Path?>/app/libs/js/script2.js?202110261851"></script>
		<script type="text/javascript" src="<?=Path?>/espera.js?202110261851"></script>
