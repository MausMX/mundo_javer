<div class="container-fluid registroms mt-5">
	<div class="col-12 d-flex justify-content-center">
		<div class="col-lg-8 col-xl-8 col-sm-12 col-md-8 col-xs-12 text-center contenido-contador">
			<p class="poppins c-white bold font-50 title-preheat mb-5">EL MUNDO DE LAS OPORTUNIDADES: <br>¡TU MOMENTO ES AHORA!</p>
			<p class="poppins c-white font-18 mb-4">Mundo Javer es una expo inmobiliaria como nunca habías visto: completamente virtual, Buscamos acompañarte y facilitarte todos los procesos de la compra de tu nuevo hogar.  Además durante Mundo Javer, cada compra tiene premios y recompensas únicas que harán de comprar una casa, una experiencia más memorable y satisfactoria.</p>
